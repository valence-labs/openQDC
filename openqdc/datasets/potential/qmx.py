...
class QM7b(QMX):
    ...
    energy_target_names = ['CCSD(T0):cc-pVDZ', 'HF:cc-pVDZ', 'HF:cc-pVTZ', 'MP2:cc-pVTZ', 
                            'B2PLYP-D3:aug-cc-pvdz', 'B2PLYP-D3:aug-cc-pvtz', 'B2PLYP-D3:def2-svp',
                            'B2PLYP-D3:def2-tzvp', 'B2PLYP-D3:sto-3g', 'B2PLYP-D3M(BJ):aug-cc-pvdz',
                            'B2PLYP-D3M(BJ):aug-cc-pvtz', 'B2PLYP-D3M(BJ):def2-svp', 'B2PLYP-D3M(BJ):def2-tzvp',
                            'B2PLYP-D3M(BJ):sto-3g', 'B2PLYP-D3M:aug-cc-pvdz', 'B2PLYP-D3M:aug-cc-pvtz',
                            'B2PLYP-D3M:def2-svp', 'B2PLYP-D3M:def2-tzvp', 'B2PLYP-D3M:sto-3g',
                            'B2PLYP:aug-cc-pvdz', 'B2PLYP:aug-cc-pvtz', 'B2PLYP:def2-svp', 'B2PLYP:def2-tzvp', 'B2PLYP:sto-3g', 'B3LYP-D3(BJ):aug-cc-pvdz', 'B3LYP-D3(BJ):aug-cc-pvtz', 'B3LYP-D3(BJ):def2-svp', 'B3LYP-D3(BJ):def2-tzvp', 'B3LYP-D3(BJ):sto-3g', 'B3LYP-D3:aug-cc-pvdz', 'B3LYP-D3:aug-cc-pvtz', 'B3LYP-D3:def2-svp', 'B3LYP-D3:def2-tzvp', 'B3LYP-D3:sto-3g', 'B3LYP-D3M(BJ):aug-cc-pvdz', 'B3LYP-D3M(BJ):aug-cc-pvtz', 'B3LYP-D3M(BJ):def2-svp', 'B3LYP-D3M(BJ):def2-tzvp', 'B3LYP-D3M(BJ):sto-3g', 'B3LYP-D3M:aug-cc-pvdz', 'B3LYP-D3M:aug-cc-pvtz', 'B3LYP-D3M:def2-svp', 'B3LYP-D3M:def2-tzvp', 'B3LYP-D3M:sto-3g', 'B3LYP:aug-cc-pvdz', 'B3LYP:aug-cc-pvtz', 'B3LYP:def2-svp', 'B3LYP:def2-tzvp', 'B3LYP:sto-3g', 'HF:aug-cc-pvdz', 'HF:aug-cc-pvtz', 'HF:cc-pvtz', 'HF:def2-svp', 'HF:def2-tzvp', 'HF:sto-3g', 'PBE0:aug-cc-pvdz', 'PBE0:aug-cc-pvtz', 'PBE0:def2-svp', 'PBE0:def2-tzvp', 'PBE0:sto-3g', 'PBE:aug-cc-pvdz', 'PBE:aug-cc-pvtz', 'PBE:def2-svp', 'PBE:def2-tzvp', 'PBE:sto-3g', 'SVWN:sto-3g', 'WB97M-V:aug-cc-pvdz', 'WB97M-V:aug-cc-pvtz', 'WB97M-V:def2-svp', 'WB97M-V:def2-tzvp', 'WB97M-V:sto-3g', 'WB97X-D:aug-cc-pvdz', 'WB97X-D:aug-cc-pvtz', 'WB97X-D:def2-svp', 'WB97X-D:def2-tzvp', 'WB97X-D:sto-3g']
    __energy_methods__ = [
        PotentialMethod.NONE for _ in range(len(energy_target_names))  ] # "wb97x/6-31g(d)"]
