...
# "SVWN/def2-TZVP" TODO: RECALCULATE THIS
...
# pbe/def2-tzvp TODO: Recalculate this
# H -1 +1 , S -2 +2
ISO17 = {
    ("H", 0): -0.49963874688961296,
    ("Li", 1): -7.256644236856955,
    ("B", -3): None,
    ("B", -1): None,
    ("B", 0): -24.61008450990847,
    ("B", 3): -21.981186468974155,
    ("C", -1): None,
    ("C", 0): None,
    ("C", 1): -37.37216480721611,
    ("N", -1): None,
    ("N", 0): None,
    ("N", 1): None,
    ("O", -1): -75.04792601076218,
    ("O", 0): None,
    ("O", 1): None,
    ("F", -1): -99.77558183886428,
    ("F", 0): -99.66914009406861,
    ("Na", 1): -161.96413737182382,
    ("Mg", 2): -199.10001096170993,
    ("Si", 4): -285.4180171255296,
    ("Si", 0): None,
    ("Si", -4): -288.02271678330254,
    ("P", 0): None,
    ...
    ("S", 0): None,
    ("S", 1): None,
    ("Cl", -1): -460.07847287800433,
    ("Cl", 0): -459.958414417978,
    ("K", 1): -599.5277926006352,
    ("Ca", 2): -676.6655247948639,
    ("Br", -1): -2573.841523048894,
    ("Br", 0): -2573.720729522104,
    ("I", -1): -297.78153468631854,
    ("I", 0): -297.66553802494457,
}
# pbe0/def2-tzvp
QM7X_DFT = {
